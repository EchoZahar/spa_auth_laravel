                    ...
                    <div class="card-body">
                        ...
                        <form action="javascript:void(0)" @submit="register" class="row" method="post">
                            ...
                            <div class="form-group col-12 my-2">
                                ...
                                <input type="password" name="password_confirmation" v-model="user.password_confirmation" id="password_confirmation" placeholder="Password confirmation" class="form-control">
                            </div>
